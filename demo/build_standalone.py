#!/usr/bin/env python3
"""
build_standalone.py — Genera un HTML AUTÓNOMO (offline, sin servidor) que abres
con doble clic en el escritorio. Embebe el cerebro (demo/standalone_brain.js) y
...
(function () {
  ...
  var T = {
    es: {
      escritorio: "Escritorio · offline", idioma: "Idioma:",
      kicker: "Marcas · Propiedad intelectual · Patentes · Procesal",
      heroH1: "Inteligencia que <em>entiende</em> tu caso.",
      subtituloHero: "Versión de escritorio · funciona sin conexión. Orientación basada en un corpus cerrado de criterios aprobados de resoluciones reales.",
      ...
      notaEvidencia: "Evidencia del caso, no fuente jurídica. No constituye asesoramiento ni predice el resultado. Se procesa en tu equipo (offline).",
    ...
    en: {
      escritorio: "Desktop · offline", idioma: "Language:",
      kicker: "Trademarks · Intellectual property · Patents · Procedure",
      heroH1: "Intelligence that <em>understands</em> your case.",
      subtituloHero: "Desktop version · works offline. Guidance based on a closed corpus of approved criteria from real court decisions.",
      ...
      notaEvidencia: "Case evidence, not a legal source. It is not legal advice and does not predict the outcome. Processed on your device (offline).",
      enviar: "Send query",
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function catSelect(area, topic, li) {
      ...
      catRenderList(catBy(area, topic));
    }
...
<title>ILP · Asesor Informativo — versión de escritorio (offline)</title>
...
<header class="topbar"><div class="topbar-inner">
  ...
  <span style="display:flex;align-items:center;gap:16px;flex-wrap:wrap">
    <span class="brand-sub" data-i18n="escritorio" style="letter-spacing:.2em">Escritorio · offline</span>
...
<main class="contenedor">
  <section class="hero">
    ...
    <p class="subtitulo" data-i18n="subtituloHero">Versión de escritorio · funciona sin conexión. Orientación basada en un corpus cerrado de criterios aprobados de resoluciones reales.</p>
  </section>
  ...
  <form id="formulario" class="caja">
    ...
    <div id="zona-materiales" class="dropzone dropzone-archivos">
      ...
      <p class="nota-evidencia" data-i18n="notaEvidencia">Evidencia del caso, no fuente jurídica. No constituye asesoramiento ni predice el resultado. Se procesa en tu equipo (offline).</p>
  ...
  <div id="view-evaluar" class="oculto">
    <form id="form-eval" class="caja">
      ...
      <div id="ev-zona" class="dropzone dropzone-archivos">
        ...
        <p class="nota-evidencia">Solo material factual del caso. No son fuente jurídica, no crean criterios y no predicen el resultado. Se procesan en tu equipo (offline).</p>
...
<footer class="pie"><div class="pie-inner">
  ...
  <p class="pie-legal" data-i18n="pieLegal">Versión de escritorio offline · Corpus cerrado · Sin conexión a internet · La aprobación de criterios es siempre un acto humano.</p>
</div></footer>
